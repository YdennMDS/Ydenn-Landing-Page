...
export default function YourContact() {
  ...
  return (
    <div className="max-h-screen h-screen w-full bg-slate-100 flex flex-col items-center">
      ...
      <div className="flex flex-col gap-4 w-[1070px] mt-16 mb-8">
        <label
          htmlFor=""
        ...
        <input
          ...
          className="flex flex-row items-center w-full max-w-[1070px] max-h-[73px] h-screen bg-white rounded-lg justify-between pl-5 border-[#E1E3E6] outline-none"
          onChange={(e) => {
